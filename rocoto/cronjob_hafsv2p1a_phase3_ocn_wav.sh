...
HOMEhafs=/gpfs/f6/drsa-hurr1/world-shared/save/${USER}/hafsv2p1_p3_ocn_wav
...
#===============================================================================
 ...
 confopts="config.EXPT=${EXPT} config.SUBEXPT=${EXPT}_v2p1a_phase3_ocn_wav  \
    ../parm/hafsv2p1a_phase3_ocn_wav.conf \
...
#./run_hafs.py ${opts} 2024092506-2024092512 09L HISTORY ${confopts} # Helene
  ./run_hafs.py ${opts} 2024092512 09L HISTORY \
      config.NHRS=6 ${confopts}
