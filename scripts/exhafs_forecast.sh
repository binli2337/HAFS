...
run_hycom=${run_hycom:-no}
run_mom6=${run_atm_datm_ocean:-yes}
#run_mom6=${run_mom6:-yes}
...
DAT_model_component=${DAT_model_component:-""}
...
DAT_model_attribute=${DAT_model_attribute:-""}
